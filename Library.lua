...
local Library = {
    ...
    IsLightTheme = true,
    Scheme = {
        BackgroundColor = Color3.fromRGB(240, 244, 248),
        MainColor = Color3.fromRGB(255, 255, 255),
        AccentColor = Color3.fromRGB(99, 102, 241),
        OutlineColor = Color3.fromRGB(220, 226, 235),
        FontColor = Color3.fromRGB(25, 28, 35),
...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        New("UICorner", { CornerRadius = UDim.new(0, WindowInfo.CornerRadius + 2), Parent = TopBarFrame })
        New("UIStroke", { Color = "OutlineColor", Thickness = 1, Parent = TopBarFrame })
        ...
        Library:MakeDraggable(MainFrame, DragZone, false, true)
        ...
        if WindowInfo.Icon then
            New("ImageLabel", {
                Image = tonumber(WindowInfo.Icon) and ("rbxassetid://" .. tostring(WindowInfo.Icon)) or WindowInfo.Icon,
        ...
        local TitleWidth = Library:GetTextBounds(
            ...
            Library.Scheme.Font,
            18,
            TitleHolder.AbsoluteSize.X - (WindowInfo.Icon and WindowInfo.IconSize.X.Offset + 8 or 0)
        )
        New("TextLabel", {
            BackgroundTransparency = 1,
            Size = UDim2.new(0, TitleWidth + 20, 1, 0),
        ...
        New("UIPadding", { PaddingLeft = UDim.new(0, 32), PaddingRight = UDim.new(0, 10), Parent = SearchBox })
        ...
        TabsContainerFrame = New("Frame", {
            BackgroundColor3 = "MainColor",
            Name = "TabsContainer",
            Position = UDim2.new(0, 0, 0, 58),
            Size = UDim2.new(0.26, 0, 1, -84),
            Parent = MainFrame,
        })
        New("UICorner", { CornerRadius = UDim.new(0, WindowInfo.CornerRadius + 2), Parent = TabsContainerFrame })
        New("UIStroke", { Color = "OutlineColor", Thickness = 1, Parent = TabsContainerFrame })
